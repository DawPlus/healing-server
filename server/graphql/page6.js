...
const page6TypeDefs = gql`
 ...
 # 프로그램 일정표 관련 타입
  ...
  extend type Query {
    ...
    # 강사비 지급 정보 가져오기 
    getInstructorPayments(year: Int, month: Int, startDate: String, endDate: String, instructorName: String): [InstructorPayment]
    
    # 강사 목록 가져오기
    getInstructors: [Instructor]
    
    # 강사비 지급 월별 요약 정보 가져오기
    getMonthlyInstructorSummary(year: Int, month: Int, startDate: String, endDate: String): MonthlyInstructorSummary
  }
  ...
  type InstructorPayment {
    ...
    final_amount: Int
    payment_date: String
    assistant_instructor_name: String
    assistant_instructor_fee: Int
    healing_helper_name: String
    healing_helper_fee: Int
  }
  ...
  type MonthlyInstructorSummary {
    ...
    total_assistant_fee: Int
    total_helper_fee: Int
    instructor_count: Int
    session_count: Int
  }
