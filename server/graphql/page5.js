...
const page5TypeDefs = gql`
  ...
  type Query {
    ...
    # Excel Export specific query
    getExcelExportData(page1Id: Int!): ExcelExportData
    
    # Monthly reservation status query
    getMonthlyReservationStatus(year: Int!, month: Int!): [MonthlyStatusData]
  }
  ...
  type MonthlyStatusData {
    date: Int!
    day_of_week: String!
    reservations: [ReservationStatusDetail!]!
    totals: MonthlyTotals!
  }

  type ReservationStatusDetail {
    id: Int!
    group_name: String
    customer_name: String
    start_date: String
  ...
  type MonthlyTotals {
    ...
    confirmed_count: Int!
    tentative_count: Int!
    social_contribution_count: Int!
    profit_business_count: Int!
  }
