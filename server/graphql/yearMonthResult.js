...
const yearMonthResultTypeDefs = gql`
  ...
  type PreventEffect {
    smartphone: PreventEffectStats
    gambling: PreventEffectStats
    experienceStats: PreventExperienceStats
  }
  ...
  type FacilityEnvironment {
    ...
    facility_avg8: Float
    facility_avg9: Float
    facility_avg10: Float
    operation_avg1: Float
    operation_avg2: Float
    operation_avg3: Float
    operation_avg4: Float
    operation_avg5: Float
    operation_avg6: Float
    overall_satisfaction: Float
  }

  # 힐링효과 타입
  type HealingEffectStats {
    pre_avg1: Float
    pre_avg2: Float
    pre_avg3: Float
    pre_avg4: Float
