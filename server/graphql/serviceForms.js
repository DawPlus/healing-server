...
const serviceFormsTypeDefs = gql`
  ...
  type Query {
    ...
    getProgramForms(agency: String, agency_id: Int, openday: String, eval_date: String, program_id: Int, program_category_id: Int, teacher_id: Int, place: String): [ProgramForm]
    getCounselTherapyForm(id: Int!): CounselTherapyForm
    getCounselTherapyForms(agency: String, agency_id: Int, openday: String, eval_date: String, pv: String): [CounselTherapyForm!]!
    getPreventForm(id: Int!): PreventForm
    getPreventForms(agency: String, agency_id: Int, openday: String, eval_date: String, pv: String): [PreventForm]
    getPreventGamblingForm(id: Int!): PreventGamblingForm
    getPreventGamblingForms(agency: String, agency_id: Int, openday: String, eval_date: String, pv: String): [PreventGamblingForm]
    getHealingForm(id: Int!): HealingForm
    getHealingForms(agency: String, agency_id: Int, openday: String, eval_date: String, pv: String): [HealingForm]
    getHrvForm(id: Int!): HrvForm
    getHrvForms(agency: String, agency_id: Int, openday: String, eval_date: String, pv: String): [HrvForm]
  ...
  type Mutation {
    ...
    createPreventGamblingForm(input: PreventGamblingFormInput!): PreventGamblingForm
    updatePreventGamblingForm(id: Int!, input: PreventGamblingFormInput!): PreventGamblingForm
    deletePreventGamblingForm(id: Int!): Boolean
